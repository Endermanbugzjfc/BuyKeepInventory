...
class Main extends PluginBase implements Listener
{
    ...
    public function onEnable()
    {
        ...
        if($this->config->getNested("buyEnabled")) {
        ...
        $this->getServer()->getCommandMap()->register($this->getName(), new AddBuyKi($this));
        $this->getServer()->getCommandMap()->register($this->getName(), new GiveBuyKi($this));
        $this->getServer()->getCommandMap()->register($this->getName(), new TakeBuyKi($this));
    }
